...
TITLE = 'coding_agent_workbench — should you scale this coding agent?'
LINES = [
    ('$ caw adoption-report sessions.json', 'cmd'),
    ('  attempted 15 · completed 13 (86.7%) · accepted 86.7% · reverted 0%', 'dim'),
    ('  verified 6.7%', 'dim'),
    ('', 'blank'),
    ('  verdict:  DO-NOT-SCALE', 'err'),
    ('  acceptance is high, but verification is too low to trust the output', 'comment'),
    ('', 'blank'),
    ('  # a real adopt/pilot/do-not-scale call from your own session logs', 'comment'),
]
